...
SLIDES = [
    ...
    },
    {
        ...
        "bullets": [
            "PCA explained variance: PC1=23.1%, PC2=15.3%, PC3=14.6%",

            "~7 components needed for >=90% cumulative variance",
            "K-Means clustering: 3 clusters (351, 2,322, 2,413 samples)",
            "Highest correlation: wind_speed / gust_speed (r = 0.96)",
            "Recommendation: review low-contribution sensors for potential decommissioning",
        ],
    ...
    {
        "title": "Uncertainty Modeling (KDE)",
        "bullets": [
            "Total Variation (TV) distance: measures cleaning impact on distributions",
            "Highest impact: water_level (TV=0.479), water_temperature (TV=0.420)",
            "Moderate impact: barometric_pressure, diff_pressure, humidity, dew_point",
            "Lowest impact: rain (TV=0.011) - sensor producing consistently clean data",
            "Recommendation: investigate calibration for high-TV sensors",
        ],
    },
    {
        "title": "Key Recommendations",
        "bullets": [
            "1. PCA shows 7 components capture >=90% variance from 15 variables - review low-contribution sensors",
            "2. Very-High FWI days (>=20) detected - cross-reference with fire preparedness records",
            "3. High cleaning impact (TV > 0.10) on water_level, water_temp - check sensor calibration",
            "4. Rain sensor (TV = 0.011) producing high-quality data consistently",
            "5. Consider reduced sampling frequency for redundant channels to lower maintenance costs",
        ],
    },
    {
